      ...
      >
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <p className="text-[#ADB7BE] text-base mb-6 sm:text-lg lg:text-xl leading-relaxed [text-align:justify] [text-justify:inter-word]">
            Fullstack Developer with professional experience across various web
            and mobile projects, ranging from AI-powered agriculture systems,
            e-voting platforms, to enterprise ERP solutions. Skilled in building
            multi-service architectures using React.js, React Native, Laravel,
            Django, and Node.js, as well as managing PostgreSQL and MySQL
            databases. Experienced in roles as Developer, Assistant Project
            Manager, and Assistant Product Owner, with expertise in debugging,
            API testing, automated deployment, and system monitoring using
